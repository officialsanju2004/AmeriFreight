...
import { Truck, Clock, Phone, Shield, Award, CheckCircle, Star, HardHat, ShieldCheck, Wrench, Box } from "lucide-react";
...
export default function HeavyVehicleTransport() {
  ...
  const features = [
    ...
    { text: "Pay Only for What You Need – No Extra or Unused Charges", icon: <Award className="w-5 h-5" /> },
    { text: "No Hidden Fees – 100% Transparent Pricing", icon: <Shield className="w-5 h-5" /> },
    { text: "Licensed, Bonded & Insured – Total Peace of Mind", icon: <ShieldCheck className="w-5 h-5" /> },
      ...
      <div className="relative w-full h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
          ...
          >
            ...
            >
              <Box className="w-4 h-4 text-[#E8A87C]" />
              <span className="text-sm font-medium text-white/90">Heavy-Duty Specialists</span>
            </motion.div>
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto">Expert solutions for trucks, machinery, and commercial vehicles</p>
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: 80 }}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Trusted by 500+ commercial fleets</p>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20">
                  <div className="flex items-center gap-4 bg-white/10 backdrop-blur-md rounded-xl p-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">Commercial Vehicle Experts</p>
                      <p className="text-white/70 text-sm">Heavy load specialists</p>
                    </div>
                  </div>
                </div>
              </div>
