...
import { Truck, Clock, Phone, Shield, Award, CheckCircle, Star, ShieldCheck, Wind, Sun, CloudRain } from "lucide-react";
...
export default function SpecializedTransport() {
  const images = [image1, image12, image13, image4];
  ...
  const features = [
    { text: "Multi-Level Transport Trucks Available", icon: <Truck className="w-5 h-5" /> },
    { text: "24/7 Customer Support for All Your Inquiries", icon: <Clock className="w-5 h-5" /> },
    { text: "Pay Just for the Services You Use – Nothing Extra", icon: <Award className="w-5 h-5" /> },
    { text: "Licensed, Bonded, and Fully Insured for Your Peace of Mind", icon: <ShieldCheck className="w-5 h-5" /> },
    { text: "No Hidden Charges – What You See Is What You Pay", icon: <Shield className="w-5 h-5" /> },
    { text: "Top-Quality Services Delivered Right on Time – Every Time", icon: <CheckCircle className="w-5 h-5" /> },
  ];
      ...
      <div className="relative w-full h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden">
        <AnimatePresence mode="wait">
          <motion.img
            key={current}
            src={images[current]}
            alt="Auto Transport Open Trailer"
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
          ...
          >
            ...
            >
              <Wind className="w-4 h-4 text-[#E8A87C]" />
              <span className="text-sm font-medium text-white/90">Cost-Effective Solution</span>
            </motion.div>
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-4 leading-tight">
              Auto Transport 
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#E8A87C] to-[#2C5F2D]">Open Trailer</span>
            </h1>
            <p className="text-white/80 text-lg max-w-2xl mx-auto">Affordable, efficient, and reliable vehicle shipping nationwide</p>
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: 80 }}
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-[#F9F6F0] to-white py-16 md:py-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="mb-6">
                <span className="text-sm font-semibold text-[#2C5F2D] tracking-wider uppercase">Open Carrier Service</span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A2647] mt-2 leading-tight">
                  Auto Transport 
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2C5F2D] to-[#E8A87C]"> Open Trailer</span>
                </h2>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Most affordable shipping option</p>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20">
                  <div className="flex items-center gap-4 bg-white/10 backdrop-blur-md rounded-xl p-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">Multi-Vehicle Carriers</p>
                      <p className="text-white/70 text-sm">Cost-effective shipping</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Bottom Section - Transport Information */}
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
          ...
          >
            ...
            <div className="space-y-4 text-white/80 leading-relaxed pl-4 md:pl-16">
              <p>One of the most common ways to move vehicles is through open-air transport. This method typically involves loading your car onto a multi-vehicle carrier along with several others — the kind of trucks you usually see delivering cars to dealerships.</p>
              <p>While open carriers are affordable and efficient, they do leave vehicles exposed to the elements. If you're shipping just one vehicle, it can also be done on a flatbed truck, but that usually comes with a higher price tag.</p>
              <p className="font-semibold text-white pt-2">Although open-air shipping is budget-friendly and widely used, some customers prefer the extra protection of enclosed transport — especially if they're concerned about weather conditions, road debris, or simply want greater peace of mind for their vehicle.</p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-[#2C5F2D]" />
            ...
            <div className="flex items-center gap-2">
              <Sun className="w-5 h-5 text-[#2C5F2D]" />
              <span className="text-sm text-gray-600">Weather-Resistant Carriers</span>
            </div>
          </motion.div>
        </div>
      </section>
