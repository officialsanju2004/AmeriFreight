        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-4 leading-tight">
              Auto Transport 
              <span className="block text-[#FF8C00]">Open Trailer</span>
            </h1>
      ...
      <section className="relative overflow-hidden bg-[#F9F6F0] py-16 md:py-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="mb-6">
                <span className="text-sm font-semibold text-[#FF8C00] tracking-wider uppercase">Open Carrier Service</span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[] mt-2 leading-tight">
                  Auto Transport 
                  <span className="text-[#FF8C00]"> Open Trailer</span>
                </h2>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <Sun className="w-5 h-5 text-[#001E41]" />
