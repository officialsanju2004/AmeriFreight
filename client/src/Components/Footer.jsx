  ...
  return (
    <footer className="relative bg-[#001E41] text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#FF8C00]/5 rounded-full blur-3xl" />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        variants={fadeUp}
        className="relative z-10 mx-4 md:mx-8 lg:mx-20 mt-8 rounded-2xl bg-[#FF8C00] p-8 md:p-10 shadow-2xl"
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2 text-[#003366]">
              Don't Know What To Start With?
            </h2>
            <p className="text-[#003366]/80">Get a Solution For All Type Shipping</p>
          </div>
          <motion.a
      ...
      <div className="relative z-10 px-6 md:px-12 lg:px-20 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        >
          ...
          >
            <img
              ...
              className="w-24 h-24 rounded-full object-cover border-2 border-[#FF8C00] shadow-lg"
            />
          </motion.div>
        ...
        >
          <h3 className="text-lg font-semibold mb-6 relative inline-block">
            Contact Us
            <div className="absolute bottom-0 left-0 w-12 h-0.5 bg-[#FF8C00] rounded-full mt-1" />
          </h3>
          <div className="space-y-4">
            ...
            >
              <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-[#FF8C00] transition-colors duration-300">
                <MapPin className="w-4 h-4 text-white group-hover:text-white" />
              </div>
            ...
            >
              <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-[#FF8C00] transition-colors duration-300">
                <Mail className="w-4 h-4 text-white group-hover:text-white" />
              </div>
          ...
          <ul className="space-y-3">
            {quickLinks.map((link, idx) => (
              ...
              >
                ...
                >
                  <div className="w-6 h-6 bg-white/10 rounded-lg flex items-center justify-center group-hover:bg-[#FF8C00] transition-colors duration-300">
                    <div className="text-white group-hover:text-white">{link.icon}</div>
                  </div>
                  <span>{link.name}</span>
                </a>
              </motion.li>
        ...
        >
          ...
          <div className="flex gap-3 mb-6">
            {socialLinks.map((social, idx) => (
              <motion.a
                ...
                className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-[#FF8C00] transition-all duration-300 group"
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center gap-1 mt-2">
              {[1, 2, 3, 4, 5].map((star) => (
                <svg key={star} className="w-4 h-4 text-[#FF8C00] fill-[#FF8C00]" viewBox="0 0 20 20">
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center">
          <div className="flex flex-wrap items-center justify-center gap-1 text-white/60 text-sm">
            ...
            <button
              onClick={() => window.location.href = 'https://amerifreightautologistics.com'}
              className="text-[#FF8C00] font-semibold hover:text-white transition-colors duration-300"
            >
