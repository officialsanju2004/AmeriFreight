...
const About = () => {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Driven To Deliver – 
                <span className="block text-[#FF8C00] mt-2">
              ...
              >
                {[
                  ...
                  <motion.div key={index} variants={fadeUp} className="flex items-center gap-3 group">
                    <div className="w-8 h-8 bg-white/10 rounded-xl flex items-center justify-center group-hover:bg-[#FF8C00] transition-colors duration-300">
                      <div className="text-[#FF8C00] group-hover:text-white transition-colors duration-300">
                        {item.icon}
                      </div>
                    </div>
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-white/10">
                ...
                <div>
                  <div className="flex gap-0.5">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg key={star} className="w-4 h-4 text-[#FF8C00] fill-[#FF8C00]" viewBox="0 0 20 20" fill="currentColor">
      ...
      <section className="py-20 md:py-24 bg-[#F9F6F0]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="w-20 h-20 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-white/20">
                <Eye className="w-10 h-10 text-[#FF8C00]" />
              </div>
